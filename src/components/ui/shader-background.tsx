...
export function ShaderBackground({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    if (!canvasEl) return
    // Explicitly typed so the narrowing survives into the nested render closures
    ...
    return () => {
      ...
      // Release the GPU context on the next tick rather than immediately, so a
      // StrictMode/HMR remount of the same canvas can cancel it and reuse it.
